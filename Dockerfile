# This image serves as a base layer for our machine learning lab which can be found
# here: https://tinyurl.com/sigilmachinelearninglab
...
COPY .build/fix-permissions /usr/local/bin/fix-permissions
...
COPY .build/start.sh .build/start-notebook.sh .build/start-singleuser.sh /usr/local/bin/
# Currently need to have both jupyter_notebook_config and jupyter_server_config to support classic and lab
COPY .build/jupyter_notebook_config.py /etc/jupyter/
